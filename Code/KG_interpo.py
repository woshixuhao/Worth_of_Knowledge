...
Equation_name=f'KG_equation_{x_num}_in_pred'
lamda=[1,1,1,1,1]
...
#====referenced data==========
data_path = f'data/KG_insymmetry_trail.mat'
...
y_ref_clean=torch.clone(y_ref)
y_ref=y_ref+noise_level/100*torch.std(y_ref)*torch.randn([y_ref.shape[0],y_ref.shape[1]])
...
Y_valid=torch.clone(y_ref[valid_index])
